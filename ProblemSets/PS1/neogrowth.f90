...
!!$OMP THREADPRIVATE(i_e, i_ed, i_state, i_psi1, psi1_yesterday, i_psi2, psi2_yesterday, i_del, del_today, del_tomorrow, c_today, c_today_zlb, c_tomorrow, c_tomorrow_zlb, pi_today, pi_today_zlb, pi_tomorrow, pi_tomorrow_zlb, r_today, r_tomorrow, u_today, u_today_zlb, v_today, v_today_zlb, v_tomorrow, v_tomorrow_zlb, psi1_today, psi1_today_zlb, psi2_today, psi2_today_zlb, psi3_today, psi3_today_zlb, expCons, expCons_zlb, expPi, expPi_zlb, expV, expV_zlb, expCons_int, expCons_int_zlb, expPi_int, expPi_int_zlb, expV_int, expV_int_zlb)
...
do while (converged == 0 .and. it < max_it)
	...
	!!$OMP PARALLEL DO PRIVATE( tol_eqm, x_guess, x_out, fnorm, x_guess_zlb, x_out_zlb, fnorm_zlb )
